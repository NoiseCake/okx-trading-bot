...
def validate() -> None:
    ...
    Called from the entrypoint (bot.main) rather than at import time, so the
    pure modules and the client wrapper stay importable without credentials
    (e.g. for unit tests or ad-hoc inspection).
    """
